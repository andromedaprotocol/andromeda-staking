...
import logo from "../../assets/AND_Logo-Full.svg";
import "./index.css";
...
class NavBar extends Component {
      ...
      this.props.getValidators((data) => {
        if (
          ...
          const array = data.filter(
            (val) => val && val.description && val.description.identity
          );
  ...
  handleFetch(address) {
    ...
    if (
      this.props.vestingBalance &&
      !this.props.vestingBalance.value &&
    ...
    if (
      this.props.unBondingDelegations &&
      !this.props.unBondingDelegations.length &&
      !this.props.unBondingDelegationsInProgress &&
      !this.props.proposalTab &&
      !this.props.stake
    ) {
    ...
    if (
      ...
      !this.props.delegations.length &&
      !this.props.delegationsInProgress &&
      !this.props.proposalTab
    ) {
    ...
    if (
      ...
      !this.props.delegatedValidatorListInProgress &&
      !this.props.proposalTab
    ) {
  ...
  render() {
    return (
      ...
      >
        <img alt="Andromeda" src={logo} />
        <ExpansionButton />
        <div
          className={ClassNames("right_content", this.props.show ? "show" : "")}
        >
...
const stateToProps = (state) => {
  return {
    ...
    delegatedValidatorListInProgress:
      state.stake.delegatedValidators.inProgress,
    lang: state.language,
    ...
    unBondingDelegationsInProgress:
      state.accounts.unBondingDelegations.inProgress,
